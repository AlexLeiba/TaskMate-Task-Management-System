...
const ListView = dynamic(() =>
  import("@/components/layout/Protected/Pages/Board/BoardViews/ListView/ListView").then(
    (m) => m.ListView,
  ),
);
const Summary = dynamic(() =>
  import("@/components/layout/Protected/Pages/Board/BoardViews/Summary/Summary").then(
    (m) => m.Summary,
  ),
);
type Props = {
